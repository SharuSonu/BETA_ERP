      ...
      <div className="menu--list">
          ...
          <div className="submenu">
            ...
            {menuState.inventoryOpen && (
              <div className="submenu">
                ...
                <a href="#" className="submenu-item" onClick={() => handlePageChange('StockCategory')}>
                ...
                <a href="#" className="submenu-item" onClick={() => handlePageChange('Godown')}>
        ...
        {menuState.purchaseOpen && !isSidebarCollapsed && (
          <div className="submenu">
            ...
            <a href="#" className="submenu-item" onClick={() => handlePageChange('PurchaseOrders')}>
