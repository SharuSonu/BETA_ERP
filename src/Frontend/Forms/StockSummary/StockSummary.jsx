  ...
  const updateBalances = (data) => {
    ...
    return data.map((item, index) => {
      ...
      return {
        ...
        'openingBalance.rate': openingBalanceRate,
        'inwards.rate': inwardsRate,
        'outwards.rate': outwardsRate,
        'closingBalance.quantity': closingBalanceQty,
        'closingBalance.amount': closingBalanceAmount,
        'closingBalance.rate': closingBalanceRate,
      };
    });
  };
