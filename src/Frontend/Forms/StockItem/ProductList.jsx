...
import { Input, Table, Button, message, Pagination, Divider } from 'antd'; // Import Ant Design components
...
const ProductList = ({ onSelectProduct }) => {
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [companyName, currentPage, pageSize]); // Ensure useEffect dependencies are set correctly
  ...
  // Filter products, partNo, parentGroup based on search term
